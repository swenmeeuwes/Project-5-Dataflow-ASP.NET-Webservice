...
namespace DataFlowWebservice.Models
{
    public class Position : IResponseModel
    {
        ...
        //}
        //public Position(ObjectId _id, int unitId, string date, string time, float rdX, float rdY, float latitude, float longitude, int speed, int course, int numSatellite, int hdop, string dopType)
        //{
        //    this._id = _id;
        //    this.unitId = unitId;
        //    this.date = date;
        ...
        //    this._id = new ObjectId("2141241aas");
